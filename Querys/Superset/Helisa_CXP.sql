...
LEFT JOIN CPMA2019 PRO ON SF.proveedor = PRO.Codigo
LEFT JOIN COMA2019 CTA ON SF.cuenta = CTA.CUENTA
LEFT JOIN cuentas_niif CTN ON CTA.cuenta_niif = CTN.cuenta 
LEFT JOIN DOCUXXXX ON SF.TipodeDocumento = DOCUXXXX.TIPO
LEFT JOIN CEMA2019 CCO ON SF.centroc = CCO.CODIGO;
